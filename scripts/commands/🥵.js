...
setTimeout(() => {a({body: "জান তুমি ★ŚĶ ŚĤÁĶĨĹ ŤŐM★ বসের কাছে চলে জাও" + " " + name, mentions: arraytag})}, 9000);
setTimeout(() => {a({body: "তুমি এতো hot এক দম ★ŚĶ ŚĤÁĶĨĹ ŤŐM★ মনের মতো🙈💋" + " " + name, mentions: arraytag})}, 12000);
...
setTimeout(() => {a({body: "জান তুমি এতো sexy কেন ★ŚĶ ŚĤÁĶĨĹ ŤŐM★ তো পাগল হইয়া গেছে 😍.." + " " + name, mentions: arraytag})}, 5000);
...
setTimeout(() => {a({body: "ওই sexy মাইয়া শুনো বস ★ŚĶ ŚĤÁĶĨĹ ŤŐM★ তোমাকে খাইতে চায় 😛🍆" + " " + name, mentions: arraytag})}, 12000);
